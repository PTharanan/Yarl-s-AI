...
# Local development convenience if no host list was provided.
if DEBUG and not ALLOWED_HOSTS:
    ALLOWED_HOSTS = ['*']

raw_cors_allow_all = os.getenv('CORS_ALLOW_ALL_ORIGINS')
if raw_cors_allow_all is None:
    CORS_ALLOW_ALL_ORIGINS = DEBUG
else:
    CORS_ALLOW_ALL_ORIGINS = raw_cors_allow_all.strip().lower() in ('1', 'true', 'yes', 'on')

raw_cors_allowed = os.getenv('CORS_ALLOWED_ORIGINS', '')
...
# Disable APPEND_SLASH if needed for strict matching
APPEND_SLASH = False
